...
% Last Modified by GUIDE v2.5 13-Jul-2020 08:56:37
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.text2,'string','Hola jsjsjssjjsjs');
set(handles.text2,'ForegroundColor','Red');
set(handles.boton1,'visible','on');
set(handles.boton1,'visible','off');

% --- Executes on button press in botonin.
function botonin_Callback(hObject, eventdata, handles)
% hObject    handle to botonin (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.botonin,'visible','on');
